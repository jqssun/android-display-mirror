...
public class TouchscreenActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    android.widget.FrameLayout.LayoutParams drawViewParams =
        new android.widget.FrameLayout.LayoutParams(
            android.widget.FrameLayout.LayoutParams.MATCH_PARENT,
            android.widget.FrameLayout.LayoutParams.MATCH_PARENT);
    ...
    exitText.setBackgroundColor(
        com.google.android.material.color.MaterialColors.getColor(
            exitText, com.google.android.material.R.attr.colorSurfaceVariant));
    exitText.setTextColor(
        com.google.android.material.color.MaterialColors.getColor(
            exitText, com.google.android.material.R.attr.colorOnSurfaceVariant));
    ...
    backText.setBackgroundColor(
        com.google.android.material.color.MaterialColors.getColor(
            backText, com.google.android.material.R.attr.colorSurfaceVariant));
    backText.setTextColor(
        com.google.android.material.color.MaterialColors.getColor(
            backText, com.google.android.material.R.attr.colorOnSurfaceVariant));

    android.widget.LinearLayout.LayoutParams backParams =
    ...
    android.widget.FrameLayout.LayoutParams buttonLayoutParams =
        new android.widget.FrameLayout.LayoutParams(
    ...
    if ((displayId <= 0 || surface == null || !surface.isValid())
      ...
      MirrorTouchscreenBridge.TargetInfo target =
          MirrorTouchscreenBridge.findTarget(
              getIntent().getIntExtra(MirrorTouchscreenBridge.EXTRA_DISPLAY_ID, -1));
      if (target != null) {
  ...
  private void _updateImage(Bitmap bitmap) {
    if (bitmap != null) {
      ...
      if (updateCounter >= 60) {
        ...
        Log.d(
            "TouchscreenActivity",
            "60 frames in " + duration + "ms, avg " + (duration / 60.0) + "ms");
        updateCounter = 0;
      }
    }
  }
    ...
    try {
      ...
      if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
        ...
        List<ActivityTaskManager.RootTaskInfo> taskInfos =
            atm.getAllRootTaskInfosOnDisplay(displayId);
  ...
  public static class DirectDrawView extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
      ...
      for (int i = 0; i < pointerCount; i++) {
        ...
        if (points[i * 2] < -maxWidth * 0.5
            || points[i * 2] > maxWidth * 1.5
            || points[i * 2 + 1] < -maxHeight * 0.5
            || points[i * 2 + 1] > maxHeight * 1.5) {
          return true;
        }
