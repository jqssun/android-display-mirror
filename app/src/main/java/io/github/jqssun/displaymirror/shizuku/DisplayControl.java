...
public final class DisplayControl {
  ...
  static {
    ...
    try {
      Class<?> classLoaderFactoryClass =
          Class.forName("com.android.internal.os.ClassLoaderFactory");
      Method createClassLoaderMethod =
          classLoaderFactoryClass.getDeclaredMethod(
              "createClassLoader",
              String.class,
              String.class,
              String.class,
      ...
      ClassLoader classLoader =
          (ClassLoader)
              createClassLoaderMethod.invoke(
                  null,
      ...
      Method loadMethod =
          Runtime.class.getDeclaredMethod("loadLibrary0", Class.class, String.class);
