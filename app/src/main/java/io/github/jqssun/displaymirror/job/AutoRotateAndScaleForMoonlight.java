...
public class AutoRotateAndScaleForMoonlight {
  ...
  public void start(Surface outputSurface) {
    ...
    display.getRealMetrics(
        displayMetrics); // include system decorations (status bar, navigation bar)
    ...
    renderHandler.post(
        () -> {
          ...
          // create EGL Surface
          eglOutputSurface =
              EGL14.eglCreateWindowSurface(eglDisplay, eglConfig, outputSurface, null, 0);
          ...
          portraitRenderer =
              new PortraitRenderer(portraitInputTextureId, eglDisplay, eglOutputSurface);
          landscapeRenderer =
              new LandscapeRenderer(
                  landscapeInputTextureId,
                  eglDisplay,
                  eglOutputSurface,
                  virtualDisplayArgs.width,
          ...
          portraitInputSurfaceTexture.setDefaultBufferSize(
              virtualDisplayArgs.height, virtualDisplayArgs.width);
          ...
          landscapeInputSurfaceTexture.setDefaultBufferSize(
              virtualDisplayArgs.width, virtualDisplayArgs.height);
  ...
  private static class PortraitRenderer implements SurfaceTexture.OnFrameAvailableListener {
    ...
    public PortraitRenderer(
        int inputTextureId, EGLDisplay eglDisplay, EGLSurface eglOutputSurface) {
  ...
  private static class LandscapeRenderer implements SurfaceTexture.OnFrameAvailableListener {
    ...
    public LandscapeRenderer(
      ...
      this.landscapeAutoScaler =
          new LandscapeAutoScaler(externalTextureRenderer, width, height, fbo[0]);
    }
