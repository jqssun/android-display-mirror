                    ...
                    () -> {
                      ...
                      eglOutputSurface =
                          EGL14.eglCreateWindowSurface(
                              eglDisplay, eglConfig, surfaceView.getHolder().getSurface(), null, 0);

                      EGL14.eglMakeCurrent(
                          eglDisplay, eglOutputSurface, eglOutputSurface, eglContext);
                      ...
                      portraitRenderer =
                          new PortraitRenderer(
                              portraitInputTextureId, eglDisplay, eglOutputSurface);
                      landscapeRenderer =
                      ...
                      if (State.mirrorVirtualDisplay == null
                        ...
                        Surface targetSurface =
                            isLandscape ? landscapeInputSurface : portraitInputSurface;
                        ...
                        CreateVirtualDisplay.changeAspectRatio(
                            surfaceView.getWidth(), surfaceView.getHeight());
