...
//    if (!coords) {
//      BOOST_LOG(warning) << "Failed to transform touch coords, touch port may not be initialized";
//      return;
//    }
//
//    BOOST_LOG(debug) << "Touch coord transform: original=("
//                    << from_clamped_netfloat(packet->x, 0.0f, 1.0f) << ","
//                    << from_clamped_netfloat(packet->y, 0.0f, 1.0f) << ") -> transformed=("
...
//    );
//
//    BOOST_LOG(debug) << "Touch area: majorAxis=" << contact_area.first << ", minorAxis=" << contact_area.second
//                    << ", pressure=" << from_clamped_netfloat(packet->pressureOrDistance, 0.0f, 1.0f)
//                    << ", rotation=" << rotation;
//
...
//    };
//
//    BOOST_LOG(debug) << "Updating touch state: final coords=(" << coords->first << "," << coords->second << ")";
