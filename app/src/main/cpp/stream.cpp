...
// rswrapper.h redefines these to _fn variants for SIMD dispatch;
// on Android we link nanors directly, so undo the indirection.
#ifdef __ANDROID__
...
//      rtsp_stream::launch_session_clear(session_p->launch_session_id);
  ...
  namespace fec {
      ...
      // function pointer instead of lambda
